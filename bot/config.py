...
class Config:
    def __init__(self):
        try:
            ...
            self.C_LINK = config(
                "C_LINK", default="[QVA-FLiX](https://t.me/+5xwnumOZwCMwYTRh)"
            )
            ...
            self.FFMPEG = config(
                "FFMPEG",
                default='ab-av1 auto-encode -i "{}" -e libsvtav1 --svt psy-rd=0.5:hierarchical-levels=4:tile-columns=0:film-grain=0 --preset 8 --vfilter scale=-2:480:flags=bicubic:param0=0:param1=1/2 --min-vmaf 86 -o "{}"',
            )
            ...
            self.TELEGRAPH_AUTHOR = config(
                "TELEGRAPH_AUTHOR", default="QVA-FLiX|https://t.me/+5xwnumOZwCMwYTRh"
            )
            ...
            self.WORKERS = config("WORKERS", default=1, cast=int)
        except Exception:
