...
RUN dnf -qq -y upgrade --refresh && dnf -qq -y install git aria2 bash xz wget curl pv jq python3-pip mediainfo psmisc procps-ng qbittorrent-nox zstd gcc python3-devel && dnf clean all && python3 -m pip install --upgrade pip setuptools
